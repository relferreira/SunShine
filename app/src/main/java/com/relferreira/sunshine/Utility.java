...
public class Utility {
    ...
    public static String formatTemperature(Context context, double temperature, boolean isMetric) {
        ...
        return context.getString(R.string.formated_temperature, temp);
    }
    ...
    public static String getFormatedHumidity(Context context, float humidity){
        return context.getString(R.string.format_humidity, humidity);
    }

    public static String getFormatedPressure(Context context, float pressure){
    ...
    public static boolean usingLocalGraphics(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String sunshineArtPack = context.getString(R.string.format_art_url);
